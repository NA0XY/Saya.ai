...
exports.EnvSchema = zod_1.z.object({
    ...
    AWS_REGION: zod_1.z.string().min(1).default('ap-south-1'),
    EXOTEL_SID: zod_1.z.string().min(1),
    EXOTEL_API_KEY: zod_1.z.string().min(1),
    EXOTEL_API_TOKEN: zod_1.z.string().min(1),
    EXOTEL_SUBDOMAIN: zod_1.z.string().min(1).default('api.exotel.com'),
    EXOTEL_CALLER_ID: zod_1.z.string().min(1),
    ...
    EXOTEL_TIMEOUT_MS: zod_1.z.coerce.number().int().positive().default(10000),
