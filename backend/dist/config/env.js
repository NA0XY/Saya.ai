...
exports.EnvSchema = zod_1.z.object({
    ...
    COMPANION_STT_PROVIDER: zod_1.z.enum(['local_faster_whisper', 'groq_whisper']).default('groq_whisper'),
    LOCAL_STT_URL: zod_1.z.string().url().default('http://127.0.0.1:7001'),
    LOCAL_STT_TIMEOUT_MS: zod_1.z.coerce.number().int().positive().default(12000),
    COMPANION_TTS_PROVIDER: zod_1.z.enum(['piper', 'google']).default('piper'),
    PIPER_BINARY_PATH: zod_1.z.string().optional().default(''),
    PIPER_MODEL_EN_PATH: zod_1.z.string().optional().default(''),
    PIPER_CONFIG_EN_PATH: zod_1.z.string().optional().default(''),
    PIPER_HTTP_DEBUG_ENABLED: zod_1.z.string().optional().default('false'),
