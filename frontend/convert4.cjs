...
// Replace videos with SVGs as requested by the user
bodyHtml = bodyHtml.replace(/<video[^>]*id="[^\"]*7b80-video"[^>]*>.*?<\/video>/gis, '<img src="/koi-assets/67cff79fcaed643331eecdea_ico.svg" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" />');
bodyHtml = bodyHtml.replace(/<video[^>]*id="[^\"]*f197-video"[^>]*>.*?<\/video>/gis, '<img src="/koi-assets/6836d87262e4ca8706e98a77_coud01.svg" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" />');
bodyHtml = bodyHtml.replace(/<video[^>]*id="[^\"]*d6ca-video"[^>]*>.*?<\/video>/gis, '<img src="/koi-assets/6836d873d735542d459f0382_cloud02.svg" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" />');
bodyHtml = bodyHtml.replace(/<video[^>]*id="[^\"]*8da0-video"[^>]*>.*?<\/video>/gis, '<img src="/koi-assets/684784407bdfce7b70bc9062_icon12.svg" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" />');
bodyHtml = bodyHtml.replace(/<video[^>]*>.*?<\/video>/gis, '<img src="/koi-assets/684784407bdfce7b70bc9062_icon12.svg" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" />');
