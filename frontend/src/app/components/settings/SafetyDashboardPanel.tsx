  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 bg-white sketch-box text-[#D94F2B] flex items-center justify-center text-2xl shadow-sm">🛡️</div>
        <div>
          <h3 className="text-2xl font-sketch font-bold text-[#D94F2B] relative -top-1.5">Safety Dashboard</h3>
          <p className="text-sm text-[#83311A]/60 font-sketch font-medium uppercase tracking-wider">Drug interaction warnings & precautions</p>
        </div>
      </div>
      ...
      <div className="bg-white sketch-box p-6 text-[#D94F2B]" style={{ transform: 'rotate(-0.3deg)' }}>
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="relative">
            <h4 className="text-xl font-sketch font-bold uppercase tracking-widest text-[#D94F2B]">Active Precautions</h4>
            <div className="absolute -bottom-1 left-0 w-full sketch-underline border-[#D94F2B]"></div>
          </div>
          <span className="ml-auto px-4 py-1 sketch-box text-[#D94F2B] font-sketch font-bold text-sm">{warnings.length} warnings</span>
        </div>
        
        <div className="grid grid-cols-1 gap-4">
          {warnings.map((item, i) => (
            <div key={i} className="bg-white sketch-box p-5 text-[#D94F2B] sketch-shadow hover:scale-[1.01] transition-all" style={{ transform: `rotate(${i % 2 === 0 ? 0.3 : -0.3}deg)` }}>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-lg font-sketch text-[#83311A]/70 leading-relaxed">{item.warning}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="bg-[#D94F2B]/5 sketch-box p-6 text-[#D94F2B]" style={{ transform: 'rotate(0.2deg)' }}>
      ...
      <div className="text-sm font-sketch font-bold uppercase tracking-[0.2em] text-[#83311A]/30 text-center pt-4">
