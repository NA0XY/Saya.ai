...
export function QuickActions({ onCallFamily, onHelp, onRemindLater, onShowNews }: QuickActionsProps) {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-6 max-w-5xl mx-auto">
      {/* Call Family Card */}
      <button
        onClick={onCallFamily}
        aria-label="Call family"
        className="group bg-white hover:bg-gray-50 px-6 py-5 rounded-3xl border-2 border-transparent hover:border-pink-200 shadow-sm hover:shadow-md transition-all duration-300 text-left flex items-center gap-4"
      >
      ...
      <button
        ...
        className="group bg-gradient-to-br from-[#FF6B35] to-[#E85D2A] hover:from-[#ff794a] hover:to-[#f06432] px-6 py-5 rounded-3xl border-2 border-transparent shadow-[0_8px_16px_rgba(232,93,42,0.2)] hover:shadow-[0_12px_24px_rgba(232,93,42,0.3)] transition-all duration-300 text-left flex items-center gap-4"
      >
      ...
      <button
        ...
        className="group bg-white hover:bg-gray-50 px-6 py-5 rounded-3xl border-2 border-transparent hover:border-orange-200 shadow-sm hover:shadow-md transition-all duration-300 text-left flex items-center gap-4"
      >
      ...
      <button
        ...
        className="group bg-white hover:bg-gray-50 px-6 py-5 rounded-3xl border-2 border-transparent hover:border-cyan-200 shadow-sm hover:shadow-md transition-all duration-300 text-left flex items-center gap-4"
      >
